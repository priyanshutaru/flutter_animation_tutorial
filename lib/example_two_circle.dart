...
class CircularTwoColorCircle extends StatefulWidget {
  const CircularTwoColorCircle({Key? key}) : super(key: key);

  @override
  State<CircularTwoColorCircle> createState() => _CircularTwoColorCircleState();
}
...
class _CircularTwoColorCircleState extends State<CircularTwoColorCircle>
