...
class ExampleCodeSeven extends StatefulWidget {
  const ExampleCodeSeven({Key? key}) : super(key: key);

  @override
  State<ExampleCodeSeven> createState() => _ExampleCodeSevenState();
}

class _ExampleCodeSevenState extends State<ExampleCodeSeven> with TickerProviderStateMixin {
